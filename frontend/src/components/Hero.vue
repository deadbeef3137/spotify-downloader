  ...
  <div class="hero min-h-screen">
    ...
    <div class="block text-center justify-center hero-content">
      ...
      <div class="w-full text-center">
        <h1 class="mb-5 text-5xl font-bold text-base-content">SpotiLoader</h1>
        <p class="mb-5 text-base-content">
          Descarga tus canciones de Spotify con los metadatos y la carátula del álbum
        </p>
      </div>
      ...
      <div class="alert alert-info shadow-lg my-4">
        <div>
          ...
          <span class="text-left pl-8"
            >Esta interfaz web sólo permite descargar temas sueltos. <br />
            Las descargas de playlists no funcionarán.<br />
            Busca el nombre de un tema o un artista.</span
          >
        </div>
      </div>
    </div>
